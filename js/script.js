...
const apiURL = "http://api.openweathermap.org/data/2.5/weather"  // ?lat=35&lon=139&appid=36b77110cb8dde5daabb4b6771250ce2"
...
var OnGitHub = false // change this = true if sends to GitHub ( = false if work locally)
...
function getWeather(queryString, location) {
  let request = new XMLHttpRequest()
